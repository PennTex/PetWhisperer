...
serve :
	dev_appserver.py appengine/app/app.yaml appengine/webapi/app.yaml appengine/animalservice/app.yaml ${LOCAL_ENV_FLAGS}
.PHONY: serve

deploy :
	appcfg.py update appengine/app/app.yaml appengine/webapi/app.yaml appengine/animalservice/app.yaml ${ENV_FLAGS}
.PHONY: deploy

rollback :
	appcfg.py rollback appengine/app/app.yaml appengine/webapi/app.yaml appengine/animalservice/app.yaml ${ENV_FLAGS}
.PHONY: rollback
